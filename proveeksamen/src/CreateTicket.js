    ...
    return (
        <div className="App">
            ...
            <div className='Header w-full bg-white flex justify-between p-5 items-center transition-all duration-150 ease-linear'>
                <img src="https://its-norway.no/wp-content/uploads/2018/04/logo-viken.png" className="w-64"></img>
                <button className="h-full w-1/12 rounded font-bold text-white text-xl bg-green-400 p-6" onClick={() => navigate("/create")}>Create</button>
            </div>
